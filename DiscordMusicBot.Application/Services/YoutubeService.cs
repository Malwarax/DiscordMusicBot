...
public class YoutubeService(IHttpClientFactory httpClientFactory,
    YoutubeLinkService youtubeLinkService)
{
    ...
    {
        var cleanLink = youtubeLinkService.GetCleanLink(url);
    ...
    {
        var videoId = youtubeLinkService.GetVideoId(url);
